        ...
        <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form>
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    ...
                    <div class="flex items-center mb-4">
                        <label for="exampleFormControlInput2"
                            class="block mr-2 text-sm font-bold text-gray-700">Role:</label>
                        <input type="role"
                            class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                            id="exampleFormControlInput2" wire:model="role" placeholder="Enter Role"></input>
                        @error('role') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                    <div class="flex items-center mb-4">
                        <label for="exampleFormControlInput2"
                            class="block mr-2 text-sm font-bold text-gray-700">Phone:</label>
                        <input
                            class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                            id="exampleFormControlInput2" wire:model="phone" placeholder="Enter Phone"></input>
                    ...
                    {{-- <div class="flex mb-2">
                        <input id="exampleFormControlInput2" type="checkbox" wire:model="g11old_organic_utl"
                            name="g11old_organic_utl">
                        <label for="exampleFormControlInput2"
                            class="block mb-2 ml-2 text-sm font-bold text-gray-700">G11oldOrganicUtl</label>
                        @error('g11old_organic_utl') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div> --}}
                </div>
